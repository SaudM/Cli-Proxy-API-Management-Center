...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  {
    fieldId: 'credentialLimitsRpd',
    sectionId: 'network',
    labelKey: L('sections.network.credential_limits_rpd'),
    hintKey: L('sections.network.credential_limits_rpd_hint'),
    yamlKeys: ['credential-limits', 'rpd'],
  },
  {
    fieldId: 'credentialLimitsTpd',
    sectionId: 'network',
    labelKey: L('sections.network.credential_limits_tpd'),
    hintKey: L('sections.network.credential_limits_tpd_hint'),
    yamlKeys: ['credential-limits', 'tpd'],
  },
  {
    fieldId: 'credentialLimitsMaxSessions',
    sectionId: 'network',
    labelKey: L('sections.network.credential_limits_max_sessions'),
    hintKey: L('sections.network.credential_limits_max_sessions_hint'),
    yamlKeys: ['credential-limits', 'max-sessions'],
  },
  {
    fieldId: 'credentialLimitsSessionWindowMinutes',
    sectionId: 'network',
    labelKey: L('sections.network.credential_limits_session_window_minutes'),
    hintKey: L('sections.network.credential_limits_session_window_minutes_hint'),
    yamlKeys: ['credential-limits', 'session-window-minutes'],
  },
  {
    fieldId: 'credentialLimitsActiveHours',
    sectionId: 'network',
    labelKey: L('sections.network.credential_limits_active_hours'),
    hintKey: L('sections.network.credential_limits_active_hours_hint'),
    yamlKeys: ['credential-limits', 'active-hours'],
  },
  {
    fieldId: 'credentialLimitsActiveHoursJitterMinutes',
    sectionId: 'network',
    labelKey: L('sections.network.credential_limits_active_hours_jitter_minutes'),
    hintKey: L('sections.network.credential_limits_active_hours_jitter_minutes_hint'),
    yamlKeys: ['credential-limits', 'active-hours-jitter-minutes'],
  },
  {
    fieldId: 'credentialLimitsLimitJitterPercent',
    sectionId: 'network',
    labelKey: L('sections.network.credential_limits_limit_jitter_percent'),
    hintKey: L('sections.network.credential_limits_limit_jitter_percent_hint'),
    yamlKeys: ['credential-limits', 'limit-jitter-percent'],
  },
  {
