...
export const FIELD_VALUE_KEYS: Record<string, readonly string[]> = {
  ...
  credentialLimitsRpd: ['credentialLimitsRpd'],
  credentialLimitsTpd: ['credentialLimitsTpd'],
  credentialLimitsMaxSessions: ['credentialLimitsMaxSessions'],
  credentialLimitsSessionWindowMinutes: ['credentialLimitsSessionWindowMinutes'],
  credentialLimitsActiveHours: ['credentialLimitsActiveHours'],
  credentialLimitsActiveHoursJitterMinutes: ['credentialLimitsActiveHoursJitterMinutes'],
  credentialLimitsLimitJitterPercent: ['credentialLimitsLimitJitterPercent'],
